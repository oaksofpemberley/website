...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://drive.google.com/file/d/1IFWI4Pol_A5oIdZ_plZZ7yTKfbM0e8q9/view?usp=sharing" variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Ron, a technical business management consultant with expertise in navigating the DoD. As a former computer engineer, acquisitions, staff, budget, congressional, and data officer I find fulfillment in helping see businesses grow their DoD footprint and people succeed. I’m the founder of Track-Record.co, an LLC that works with
